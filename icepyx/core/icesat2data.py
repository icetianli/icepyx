...
#         REFACTOR: add test to make sure there's a session
    ...
    def visualize_spatial_extent(self, elevplot=False): #additional args, basemap, zoom level, cmap, export
        """
        ...
        Parameters
        ----------
        elevplot : boolean, default False
        ...
        if elevplot:
            if self.extent_type == 'bounding_box':
                ...
                if not extent_flag:
                    ...
                    parallel_data = {pool.submit(self.OA_request, paralist): paralist for paralist in para_lists}
